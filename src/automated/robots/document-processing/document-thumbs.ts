...
export const document_thumbs_robot_schema = z.object({
  robot: z.literal("/document/thumbs"),
  page: z.union([z.number().int(), z.null()]).default(null).optional()
...
`),
  delay: z.union([z.number().int(), z.null()]).default(null).optional()
...
`),
  density: z.union([z.string(), z.null()]).default(null).optional()
...
`),
  output_meta: z
    ...
    .default({})
    .optional().describe(`Generally, this parameter allows you to specify a set of metadata that is
