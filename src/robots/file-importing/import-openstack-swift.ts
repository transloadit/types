...
export const importOpenstackSwiftRobotSchema = z.object({
  ...
  credentials:
    credentialsSchema.describe(`Please create your associated Template Credentials in your Transloadit account and use the name of your Template Credentials as this parameter's value. They will contain the values for your Swift bucket, Key, Secret and Bucket region.
