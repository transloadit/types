...
export const importAmazonS3RobotSchema = z.object({
  robot: z.literal("/s3/import"),
  credentials:
    credentialsSchema.describe(`Please create your associated Template Credentials in your Transloadit account and use the name of your Template Credentials as this parameter's value. They will contain the values for your S3 bucket, Key, Secret and Bucket region.
...
If it points to a directory, indicated by a trailing slash (\`/\`), then all files that are direct descendants to this directory will be imported.
...
export type ImportAmazonS3Robot = z.infer<typeof importAmazonS3RobotSchema>;
